...
| <a name="input_route53_zone_id"></a> [route53\_zone\_id](#input\_route53\_zone\_id) | Zone id where to create cognito admin portal custom domain record. | `string` | `""` | no |
